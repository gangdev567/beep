...
public class DashboardController {
    ...
    @GetMapping("/dashboard/u/{username}/home")
    public String userDashboardHome(@PathVariable("username") String username, Authentication authentication, Model model) {
        log.info("대시보드 접속: 사용자 ID = {}", username);
        ...
        if (!userDetails.getUsername().equals(username)) {
            log.warn("접근 시도된 userId {} 와 인증된 사용자의 userId {} 가 일치하지 않습니다.", username, userDetails.getUsername());
