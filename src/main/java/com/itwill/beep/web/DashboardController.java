...
public class DashboardController {
    ...
    // 공통 모델 설정 메소드
    private String commonModelSetup(String username, Authentication authentication, Model model, String viewName) {
        ...
        if (!userDetails.getUsername().equals(username)) {
            ...
            log.warn("Attempted access with mismatched username: {} (auth: {})", username, userDetails.getUsername());
            return "redirect:/";
        }
    ...
    private String determinePathPrefix(String viewName) {
        ...
        String pathPrefix = "";
         ...
         if (viewName.equals("analytics") || viewName.equals("community") || viewName.equals("content") ||
            viewName.equals("settings") || viewName.equals("viewer-rewards")) {
    ...
    // 대시보드 홈
    @GetMapping("/home")
    public String userDashboardHome(@PathVariable String username, Authentication authentication, Model model) {
    ...
    public String streamManager(@PathVariable String username, Authentication authentication, Model model) {
    ...
    public String streamAlerts(@PathVariable String username, Authentication authentication, Model model) {
    ...
    public String analyticsOverview(@PathVariable String username, Authentication authentication, Model model) {
    ...
    public String analyticsResearch(@PathVariable String username, Authentication authentication, Model model) {
    ...
    public String analyticsAchievements(@PathVariable String username, Authentication authentication, Model model) {
    ...
    public String analyticsStreamSummary(@PathVariable String username, Authentication authentication, Model model) {
    ...
    public String analyticsViewerDiscovery(@PathVariable String username, Authentication authentication, Model model) {
    ...
    public String analyticsViewerEngagement(@PathVariable String username, Authentication authentication, Model model) {
    ...
    public String communityRoles(@PathVariable String username, Authentication authentication, Model model) {
    ...
    public String communityActivity(@PathVariable String username, Authentication authentication, Model model) {
    ...
    public String communityFollowersList(@PathVariable String username, Authentication authentication, Model model) {
    ...
    public String contentVideoProducer(@PathVariable String username, Authentication authentication, Model model) {
    ...
    public String contentCollections(@PathVariable String username, Authentication authentication, Model model) {
    ...
    public String contentClips(@PathVariable String username, Authentication authentication, Model model) {
    ...
    public String contentClaims(@PathVariable String username, Authentication authentication, Model model) {
    ...
    public String settingsStream(@PathVariable String username, Authentication authentication, Model model) {
    ...
    public String settingsChannelInfo(@PathVariable String username, Authentication authentication, Model model) {
    ...
    public String settingsChannelBrand(@PathVariable String username, Authentication authentication, Model model) {
    ...
    public String settingsChannelFeaturedContent(@PathVariable String username, Authentication authentication, Model model) {
    ...
    public String settingsChannelSchedule(@PathVariable String username, Authentication authentication, Model model) {
    ...
    public String settingsModeration(@PathVariable String username, Authentication authentication, Model model) {
    ...
    public String viewerRewardsDrops(@PathVariable String username, Authentication authentication, Model model) {
    ...
    public String viewerRewardsRewardCampaigns(@PathVariable String username, Authentication authentication, Model model) {
    ...
    public String guestStar(@PathVariable String username, Authentication authentication, Model model) {
    ...
    public String broadcastTools(@PathVariable String username, Authentication authentication, Model model) {
    ...
    public String extensions(@PathVariable String username, Authentication authentication, Model model) {
